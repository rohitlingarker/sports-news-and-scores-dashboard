...
export default function FavList() {
  ...
  const handleSportChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedSport = sportState?sportState.find((sport) => sport.id === sportId):null;
  ...
  const handleTeamChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const selectedTeam = teamState ? teamState.find((team) => team.id === teamId) : null;
  ...
  >
    ...
    {sportState && sportState.map((sport) => (
...
{selectedSport && (
  <div className="my-4">
    ...
    >
      ...
      {teamsForSelectedSport && teamsForSelectedSport.map((team) => (
