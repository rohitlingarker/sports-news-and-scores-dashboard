        ...
        {filteredMatches.map((matchItem: MatchItem) => {
          return (
            <div
              key={matchItem.id}
              className={`${
                matchItem.isRunning ? `bg-gray-800` : `bg-gray-700`
              } shadow-sm shadow-blue-600 rounded-md text-gray-100 mx-2 px-3 py-2 w-52 inline-block  hover:shadow-md hover:shadow-blue-300`}
            >
